...
export const DashboardSidebar = ({ roleLabel, user, latestMahasiswa }: any) => (
    <div className="w-full lg:w-80 lg:shrink-0 space-y-6">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow border border-gray-100 dark:border-gray-700">
            <p className="font-semibold mb-2 text-gray-900 dark:text-gray-100">Mahasiswa Baru Terdaftar</p>
            <p className="text-sm text-gray-700 dark:text-gray-400 truncate">{latestMahasiswa?.name || 'Belum ada data'}</p>
            ...
            <button
                ...
                className="w-full text-center text-blue-700 dark:text-blue-400 border border-blue-700 dark:border-blue-400 rounded py-2 text-sm hover:bg-blue-700 dark:hover:bg-blue-400 hover:text-white dark:hover:text-gray-900 transition font-medium"
            >
                Daftar Mahasiswa
            </button>
        </div>
